...
const About = () => {
    ...
    const handleCopy = () => {
        navigator.clipboard.writeText('mailto:huynt605@gmail.com.')
                    ...
                    <div className='grid-container'>
                        <div className='rounded-3xl w-full sm:h-[326px] h-fit flex justify-center items-center'>
                            <Globe
                                ...
                                labelsData={[{lat: 40, lng: -100, text: 'Huy, Viet Nam', color: 'white', size: 15}]}
                            />
                        </div>
                    ...
                    <div className='grid-container'>
                        ...
                        <div className='space-y-2'>
                            ...
                            <div className='copy-container' onClick={handleCopy}>
                                ...
                                <p className="lg:text-2xl md:text-xl font-medium text-gray_gradient text-white">huynt605@gmail.com</p>
                            </div>
                        </div>
                    </div>
                </div>
